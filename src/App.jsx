...
let [passwordUi, setPassword] = useState("")
// let [paslenght, setPaslenght] = useState(8)
// let [abc, setAbc] = useState("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
// let [symbol, setsymbol] = useState("!@#$^&*()-+~")
// let [num, setNum] = useState("0123456789")
...
function App() {
  ...
  return <div>
    ...
    <input type="text" />
    <button onClick={generatePassword}>Genrate</button>
  </div>
}
